...
def eliminar():
    ...
    def eliminar():
        ...
        if seleccion:
            ...
            # refresh el Combobox después de eliminar el registro
            refresh_combobox()
        else:
    ...
    # Crear un botón para refresh el Combobox
    boton_refresh = tk.Button(pestaña_eliminar, text="refresh", command=refresh_combobox)
    boton_refresh.pack()
    ...
    # refresh el Combobox al cargar la función eliminar()
    refresh_combobox()
...
def actualizar():
    ...
    # Botón de refresh
    boton_refresh = tk.Button(pestaña_actualizar, text="refresh", command=refresh)
    boton_refresh.pack()
...
pestañas.add(pestaña_mostrar, text="Mostrar")
pestañas.add(pestaña_agregar, text="Agregar")
pestañas.add(pestaña_eliminar, text="Eliminar")
pestañas.add(pestaña_actualizar, text="Actualizar")
pestañas.add(pestaña_calcular, text="Calcular")
...
boton_mostrar = tk.Button(pestaña_mostrar, text="Mostrar Registros", command=mostrars)
boton_mostrar.pack()

boton_calcular = tk.Button(pestaña_calcular, text="Calcular Precio Promedio", command=calcular_precio_prom)
boton_calcular.pack()
